    ...
    data () {
      return {
        ...
        decisions: [
          ...
          {
            id: "10",
            description: "Would you like to have dinner with your friends?",
          ...
          {
            id: "11",
            description: "Would you like to read a book?",
          ...
          {
            id: "12",
            description: "Would you like to clean your room?",
          ...
          {
            id: "13",
            description: "Would you like to learn playing an instrument?",
          ...
          {
            id: "14",
            description: "Would you like to learn a new language?",
          ...
          {
            id: "15",
            description: "Would you like to bake some cookies?",
          ...
          {
            id: "16",
            description: "Would you like to volunteer in a social activity?",
          ...
          {
            id: "17",
            description: "Would you like to try a new sport activity?",
          ...
          {
            id: "18",
            description: "Would you like to post content in your social network?",
          ...
          {
            id: "19",
            description: "Would you like to learn some art skills?",
          ...
          {
            id: "20",
            description: "Would you like to invite some friends and have a slumber party?",
